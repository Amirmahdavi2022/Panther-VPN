...
**Turbo** روی هستهٔ [Aether](https://github.com/CluvexStudio/Aether) ساخته شده و از همون WARP کلادفلر استفاده می‌کنه. آی‌پی و اپراتورت رو قایم می‌کنه ولی تقریباً همون‌جا می‌مونی. شبکه‌ای که پشتشه اصلاً برای همین ساخته شده، برای همین سایت‌ها همچنان کشور خودت رو می‌بینن.
