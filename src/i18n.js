const en = {
  ...
  'status.disconnected':'Panther Ready','status.connected':'Panther Active','status.connecting':'Connecting…','status.disconnecting':'Disconnecting…','status.scanning':'Scanning…','status.reconnecting':'Reconnecting…','status.error':'Connection error',
  'connection.ready':'','connection.connected':'','connection.connecting':'Preparing a secure route.','connection.disconnecting':'Restoring your network.','connection.reconnecting':'Recovering the secure route.','connection.error':'Panther needs attention.','connection.tap':'Tap to secure',
  ...
  'about.title':'About','about.original':'Original Project: Aether','about.originalCredit':'Based on the original Aether project by CluvexStudio.','about.application':'Application: Panther VPN','about.applicationCredit':'Android/Windows application and interface developed for Aether.',
  'picker.empty':'No applications found','picker.added':'Executable added','picker.selected':'selected','toast.updated':'Panther is up to date','toast.telegram':'Telegram is unavailable; opened the browser.'
};
...
const fa = {
  ...
  'status.disconnected':'Panther Ready','status.connected':'Panther Active','status.connecting':'در حال اتصال…','status.disconnecting':'در حال قطع اتصال…','status.scanning':'در حال اسکن…','status.reconnecting':'در حال اتصال مجدد…','status.error':'خطای اتصال',
  'connection.ready':'برای محافظت از اتصال آماده است.','connection.connected':'','connection.connecting':'در حال آماده‌سازی مسیر امن.','connection.disconnecting':'در حال بازیابی شبکه.','connection.reconnecting':'در حال بازیابی مسیر امن.','connection.error':'Panther نیاز به بررسی دارد.',
  ...
  'config.mode':'حالت اتصال','config.vpn':'VPN دستگاه','config.smart':'اتصال هوشمند','config.proxy':'پروکسی SOCKS5','config.protocol':'پروتکل','config.scan':'حالت اسکن','config.transport':'انتقال MASQUE','config.endpoint':'نقطه پایانی سفارشی','config.reconnect':'اتصال مجدد خودکار','config.reconnectHelp':'بازیابی پس از خطاهای موقت','config.dns':'مسیریابی خصوصی DNS','config.dnsHelp':'مسیریابی DNS از Panther','config.kill':'مسدودسازی هنگام خطا','config.killHelp':'مسدود کردن ترافیک هنگام بازیابی',
  'split.title':'تونل تفکیکی','split.help':'انتخاب کنید کدام برنامه‌ها از Panther استفاده کنند','split.include':'شامل برنامه‌ها','split.exclude':'مستثنا کردن برنامه‌ها','split.select':'انتخاب برنامه‌ها','split.search':'جست‌وجوی برنامه‌ها','split.add':'افزودن فایل اجرایی',
  ...
  'about.title':'درباره','about.original':'پروژه اصلی: Aether','about.originalCredit':'بر پایه پروژه اصلی Aether از CluvexStudio.','about.application':'برنامه: Panther VPN','about.applicationCredit':'برنامه و رابط Android/Windows توسعه‌یافته برای Aether.',
  'picker.empty':'برنامه‌ای پیدا نشد','picker.added':'فایل اجرایی افزوده شد','picker.selected':'انتخاب‌شده','toast.updated':'Panther به‌روز است','toast.telegram':'تلگرام در دسترس نیست؛ مرورگر باز شد.'
};
